...
4. If the caller asks about a job, activity, pour date, formwork date, sand up date, sanding up date, when work starts on site, supplier delivery timing, job readiness, or schedule:
   ...
   - SAND SUPPLIER SAFE CASE: Only if both Sand Up and Drains have confirmed dates AND Drains is on a date strictly before Sand Up may you say the job is ready for sand delivery. Give the Sand Up date and say the sand needs to be there by 7:00 a.m.
