...
- EXISTING JOB VARIATION WITH NO MATCHING RECENT QUOTE: Ask for the existing job address or job number if needed, then collect only the extra work being quoted, rough size/finish if relevant, and timing preference. Do not ask whether it is the "same enquiry" and do not ask what has changed since a previous call.
