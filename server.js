  ...
  function connectToOpenAI() {
    ...
    openAiWs.on("message", async (data) => {
      ...
      if (msg.type === "response.output_audio.delta" && msg.delta) {
        // msg.delta is raw mulaw bytes from OpenAI; Twilio expects base64
        const base64Payload = Buffer.from(msg.delta, "binary").toString("base64");
        console.log("[AUDIO_DELTA] Forwarding " + base64Payload.length + " base64 chars to Twilio (streamSid: " + streamSid + ")");
